ShpostPackage::Application.routes.draw do
  ...
  resources :query_results do
    collection do 
      ...
      post 'pkp_export'
      get 'railway_allocation_import'
      post 'railway_allocation_import' => 'query_results#railway_allocation_import'
      get 'railway_allocation_index'
      post 'railway_allocation_index'
      post 'railway_allocation_export'
      # get 'abnormal_import'
