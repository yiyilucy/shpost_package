class CreatePkpWaybillBaseLocals < ActiveRecord::Migration
  def change
    create_table :pkp_waybill_base_locals do |t|
    ...
    add_index :pkp_waybill_base_locals, :waybill_no
    add_index :pkp_waybill_base_locals, :sender_no
    add_index :pkp_waybill_base_locals, :created_day
  end
end
